...
[refX, refY, refZ] = meshgrid((0:reference.width(2):reference.width(2) * ...
    (reference.dimensions(2) - 1)) - (reference.width(2) * ...
    (reference.dimensions(2))) / 2, (0:reference.width(1):reference.width(1) * ...
    (reference.dimensions(1) - 1)) - (reference.width(1) * ...
    (reference.dimensions(1))) / 2, (0:reference.width(3):reference.width(3) * ...
    (reference.dimensions(3) - 1)) - (reference.width(3) * ...
    (reference.dimensions(3))) / 2);
...
% Generate x, y, and z grids using start and width structure fields (which
% are stored in [x,z,y] format)
[secX, secY, secZ] = meshgrid((0:daily.width(2):daily.width(2) * ...
    (daily.dimensions(2) - 1)) - (daily.width(2) * ...
    (daily.dimensions(2))) / 2, (0:daily.width(1):daily.width(1) * ...
    (daily.dimensions(1) - 1)) - (daily.width(1) * ...
    (daily.dimensions(1))) / 2, (0:daily.width(3):daily.width(3) * ...
    (daily.dimensions(3) - 1)) - (daily.width(3) * ...
    (daily.dimensions(3))) / 2);
